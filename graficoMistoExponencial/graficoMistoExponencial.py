...
def analisaTempo():
    ...
    for i in range(numIntervalos + 1):
        resMedia[0].append(tamInicial * (10 ** i)) #Num elementos
    ...
    print("Tamanho final:", tamInicial * (10 ** (numIntervalos)))
...
layout = [
    ...
    [sg.Text('Expoente'), sg.Input(key = 'numIntervalos', size=(10,1))],
