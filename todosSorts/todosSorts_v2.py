...
#GRAFICO
def mostraGrafico(resultados, resMedia):
    #Grafico
...
tamInicial = 1000 #Número mínimo de elementos
numIntervalos = 5 #Número máximo = tamInicial*numIntervalos
tamAmostra = 5 


for i in range(numIntervalos): # i vai de 0 a (numIntervalos -1)
    numElementos = tamInicial * (1 + i)
...
mostraGrafico(resultados, resMedia)
